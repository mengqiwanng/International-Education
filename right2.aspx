<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" Debug="true"CodeFile="right2.aspx.cs" Inherits="right2" StylesheetTheme="list"%>
             ...
             <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></h3>
              <ul>
                  <asp:Repeater ID="Repeater2" runat="server">
                      <ItemTemplate >
                        <li><a href="xaingxi.aspx?cl1_id=<%#Eval("cl1_id") %>&id=<%#Eval ("id")%>"><%#Eval("title")%></a><span><%#Eval("datatime", "{0:yyyy-MM-dd}")%></span></li>
                      </ItemTemplate>
                  </asp:Repeater> 
              </ul> 
        <div id="page">
